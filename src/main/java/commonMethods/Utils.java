...
public class Utils {
	...
	public static String testDataFile=System.getProperty("user.dir")+"/data";
	...
	public static String getDataFromTestData(String autoTestCaseNameVal, String label) {
		...
		try {
			FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+"/data/Test_data.xlsx");
