...
//	}
	...
	public  void add(WebDriver driver,String paramString1, String paramString2, LogAs paramLogAs,
		...
		Steps localSteps = new Steps();
		 StringBuilder sb = new StringBuilder(paramString1);

		    int i = 0;
		    while ((i = sb.indexOf(" ", i + 30)) != -1) {
		        sb.replace(i, i + 1, "\n");
		    }
		localSteps.setDescription(sb.toString());
	...
	@Deprecated
	public  void add2(String paramString1, String paramString2, boolean paramBoolean,String object,String paramString3) {
		Steps localSteps = new Steps();
	...
	@Deprecated
	public  void add3(String paramString1, String paramString2, boolean paramBoolean,String object,String paramString3) {
